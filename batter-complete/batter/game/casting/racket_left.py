...
from game.casting.point import Racket


class RacketLeft(Racket):
    ...
    def swing_left(self): #this needs to change probably to up
        """Steers the bat to the left."""
        velocity = Point(-RACKET_VELOCITY, 0)
        self._body.set_velocity(velocity)

    def swing_right(self): #this needs to change probably to down
